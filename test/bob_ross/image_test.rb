  ...
  test 'resize an image' do
    ...
    assert_transform(image, {resize: '100'}, {
      ...
      signature: [
        ...
        '5c86d9f437c1cbc9827b36d1c08d5bd4d8b31828786f194cd2a7f2fd125868c8'
      ]
    })
    ...
    assert_transform(image, {resize: 'x100'}, {
      ...
      signature: [
        ...
        '6d1bd3539daa6de5e6cb8b97f1e90cc6e0c5694d0bc2abe0aa5fe01c27717ba7'
      ]
    })
    ...
    assert_transform(image, {resize: '200x200>'}, {
      ...
      signature: [
        ...
        '47c34660701ddc02c5f18ba41392c3fe6188b1339c92d71ed324d3184d86173e'
      ]
    })
    ...
    assert_transform(image, {resize: '200x200#p0855AA'}, {
      geometry: '200x200',
      signature: [
        'd0900a56baa9dc3ca3f3499263565eca2f3595023b999a1308cabc01f0266a74',
        '10927e09b94dffc29842d3e760d9a02c7e3ce7eef613aba45dcba1abe4297a56'
      ]
    })
    ...
    assert_transform(image, {resize: '200x200*'}, {
      ...
      signature: [
        ...
        'e2d39515596ec280e3f92b2f767ae90aec51c26b593e82214d023c8e45686aa4'
      ]
    })
    ...
    assert_transform(image, {resize: '200x200*w'}, {
      ...
      signature: [
        ...
        '1033fa0394f2d141f2fcf8ad40c6dfe9eb7f189a793101c8fef0ae75b5a87d78'
      ]
    })
  end
  ...
  test 'watermarking' do
    ...
    assert_transform(image, {watermark: '0n'}, {
      ...
      signature: [
        ...
        'd8150ea6d115d3c8efe057dadb29d14cab18632c79b793733c1e783123d3d550'
      ]
    })
    ...
    assert_transform(image, {watermark: '0e'}, {
      ...
      signature: [
        ...
        '466e0a4bddc703ef20e204f231f527af790125258324a4c30887fd554469ffde'
      ]
    })
    ...
    assert_transform(image, {watermark: '0s'}, {
      ...
      signature: [
        ...
        '12b5083c881fa9181b422b0401751b8cd67db8cb5dbd08e0b23b9c04975bf518'
      ]
    })
    ...
    assert_transform(image, {watermark: '0w'}, {
      ...
      signature: [
        ...
        'da1cbac5054ead31a5ae23b8c84bc0f98d6db0902dbbdcd0780ff33d71a2a0ef'
      ]
    })
    ...
    assert_transform(image, {watermark: '0c'}, {
      ...
      signature: [
        ...
        '27615eca788c158171358c68eaa0659c9af36a8b8965d33368871b39e7dc3f12'
      ]
    })
    ...
    assert_transform(image, {watermark: '0ne'}, {
      ...
      signature: [
        ...
        '2199b4270d9d090851c7389aaa6d5d805fd0d8df7558a2dd76a00557a380d024'
      ]
    })
    ...
    assert_transform(image, {watermark: '0se'}, {
      ...
      signature: [
        ...
        '6016482bcc48e09ae0dc59d26c3cc8b5a03867f5a23abfcdb51027077e8866ec'
      ]
    })
    ...
    assert_transform(image, {watermark: '0sw'}, {
      ...
      signature: [
        ...
        '76164d3a1db2e3fe22fdae6c434526bf98361679c480c16d75f83d1a80e0622e'
      ]
    })
    ...
    assert_transform(image, {watermark: '0nw'}, {
      ...
      signature: [
        ...
        'b4d2817d7cbefedb2c55662319f9e85a9409f98509f7e738cb3a25e2446bc4a1'
      ]
    })
    ...
    assert_transform(image, {watermark: '0o'}, {
      geometry: '720x480',
      signature: [
        '3bc8daf0df761fc42eea4806aef4dea429569e0d739d2c30c57de387744455e0',
        'c5702ec9cb41d1202c502c55fb16abfcb85a9a165bc0b356040c21c64ccff6ca'
      ]
    })
  end
